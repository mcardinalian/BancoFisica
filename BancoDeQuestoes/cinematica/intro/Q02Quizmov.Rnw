...
aleat = sample(1:5)
  ...
  questions[aleat[1]] <- "Uma velocidade média de 30 m/s significa que a cada 30 segundos, um objeto se move 30 metros."
  solutions[aleat[1]] <- FALSE
  explanations[aleat[1]] <- "O objeto percorre 30 metros a cada 1 segundo"
  questions[aleat[2]] <- "Uma velocidade média de 30 m/h significa que a cada 1 hora, um objeto se move 30 metros"
