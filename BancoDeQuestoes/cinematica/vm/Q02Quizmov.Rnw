...
aleat = sample(1:5)
  ...
  questions[aleat[2]] <- "Uma velocidade de 30 m/h significa que a cada 1 hora, um objeto se move 30 metros"
  ...
  questions[aleat[5]] <- "Um ônibus que gasta 15 minutos para percorrer 20 km possui velocidade de 80 km/h"
